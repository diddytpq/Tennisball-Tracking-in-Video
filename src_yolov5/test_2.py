...
def main(input_video):
    ...
    if args.record:
        ...
        out = cv2.VideoWriter("tennis_tracking.mp4", codec, fps, (1440,810))
    ...
    while cap_main.isOpened():
        ...
        try:
            ...
            continue
        ball_detect_img, ball_cand_box_list_left, ball_cand_box_list_right, test_img = ball_tracking(frame_mog2, args.debug)  #get ball cand bbox list
        ...
        frame_record = cv2.hconcat([frame_main,test_img])
